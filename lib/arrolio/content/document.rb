...
module Arrolio
  module Content
    class Document
      attr_reader :metadata, :sections, :preface, :bibliography, :cover, :style_id
      ...
      def hash
        [self.class, metadata, sections, preface, bibliography, cover, style_id].hash
      end
